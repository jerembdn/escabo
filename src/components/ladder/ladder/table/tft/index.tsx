...
import { Player, PlayerLeague, QueueType } from "@prisma/client";
...
const LadderTftTable: React.FC<LadderTableProps> = ({
  ...
  const tableData = !players
    ...
    : players
        .map((player) => {
          const league: PlayerLeague = player.leagues.find(
          ...
          return {
            ...
            top4rate: (league.wins / (league.wins + league.losses)) * 100,
